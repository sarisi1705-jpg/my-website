...
export function SiteFooter() {
  return <footer><div className="footer-inner mx-auto grid max-w-[1440px] gap-8 px-4 py-10 sm:px-8 lg:grid-cols-[1.2fr_1fr_1fr] lg:px-12">
    ...
    <div className="footer-links"><strong>روابط سريعة</strong><a href="/about">من نحن</a><a href="/products">المنتجات</a><a href="/offers">العروض</a><a href="/contact">تواصل معنا</a></div>
