...
import { ClipboardList, ExternalLink, FolderTree, History, LayoutDashboard, LogOut, Menu, Package, Send, ShoppingCart, Tags, UserCog, Users, X } from "lucide-react";
import { Button } from "@/components/ui/button";

const icons = { dashboard: LayoutDashboard, orders: ShoppingCart, inquiries: ClipboardList, products: Package, categories: FolderTree, brands: Tags, users: Users, telegram: Send, audit: History, account: UserCog };
